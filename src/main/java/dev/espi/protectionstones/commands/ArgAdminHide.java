                ...
                if (ProtectionStones.isPSRegion(r)) {
                    ...
                    if (region != null) {
                        if (args[1].equalsIgnoreCase("hide")) {
                            ProtectionStones.getInstance().getModernScheduler().runAtLocation(region.getProtectBlock().getLocation(), region::hide);
                        } else if (args[1].equalsIgnoreCase("unhide")){
                            ProtectionStones.getInstance().getModernScheduler().runAtLocation(region.getProtectBlock().getLocation(), region::unhide);
                        }
                    }
                }
            }
